...
class SignupStep2 extends StatelessWidget {
  ...
  void _selectRoleAndContinue(BuildContext context, String role) {
    ...
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => SignupStep3(data: data)));
  }
      ...
      child: Column(
        ...
        children: [
          ...
          CyanButton(
              ...
              onPressed: () => _selectRoleAndContinue(context, "Boat Owner")),
          const SizedBox(height: 16),
          CyanButton(
              text: "Crew Member",
              icon: Icons.arrow_circle_right_outlined,
              onPressed: () => _selectRoleAndContinue(context, "Crew Member")),
