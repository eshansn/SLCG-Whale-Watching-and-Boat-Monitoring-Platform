...
class OwnerProfileScreen extends StatefulWidget {
  ...
  @override
  State<OwnerProfileScreen> createState() => _State();
}
...
class _State extends State<OwnerProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final selected = imagePath ?? p.imagePath;
    return OwnerLayout(
        child: SingleChildScrollView(
            ...
            child:
                ...
                GestureDetector(
                    ...
                    child: CircleAvatar(
                        ...
                        backgroundImage: selected != null
                            ...
                            : const AssetImage(
                                    'assets/images/profile_kamal.jpg')
                                as ImageProvider,
                        child: const Align(
              ...
              label('NIC No.'),
              field(TextEditingController(text: p.nic), readOnly: true),
              label('Your Email'),
              field(TextEditingController(text: p.email),
                  readOnly: true, icon: Icons.mail_outline),
              label('Phone Number'),
              field(phone, icon: Icons.phone_outlined),
              label('Address'),
              field(address),
              label('About'),
              field(about, maxLines: 3),
  ...
  Widget field(TextEditingController c,
          {IconData? icon, int maxLines = 1, bool readOnly = false}) =>
      TextField(
          controller: c,
          maxLines: maxLines,
          readOnly: readOnly,
