...
class OwnerNotificationsScreen extends StatefulWidget {
  ...
  @override
  State<OwnerNotificationsScreen> createState() => _OwnerNotificationsState();
}
...
class _OwnerNotificationsState extends State<OwnerNotificationsScreen> {
      ...
      child: Column(children: [
        Padding(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
            ...
            TextButton(
                onPressed: store.notifications.isEmpty ? null : _confirmClear,
                      ...
                      title: Text(notification.title,
                          style: TextStyle(
                              fontWeight: notification.isRead
                                  ...
                                  : FontWeight.bold)),
                      subtitle: Text(
                          '${notification.category} · ${_time(notification.timestamp)}\n${notification.message}'),
                      isThreeLine: true,
                      trailing: IconButton(
  ...
  Future<void> _confirmClear() async {
    final confirmed = await showDialog<bool>(
        ...
        false;
    if (confirmed) store.clearNotifications();
  }
}
