...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhaleWatching.Api.Domain.Boat", b =>
                {
                    ...
                    b.HasIndex("GpsDeviceId")
                        .IsUnique()
                        .HasFilter("[GpsDeviceId] IS NOT NULL AND [IsDeleted] = 0");
            ...
            modelBuilder.Entity("WhaleWatching.Api.Domain.SosAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SosEventId", "TakenAtUtc");

                    b.ToTable("SosActions");
                });
            ...
            modelBuilder.Entity("WhaleWatching.Api.Domain.SosAction", b =>
                {
                    b.HasOne("WhaleWatching.Api.Domain.SosEvent", "SosEvent")
                        .WithMany("Actions")
                        .HasForeignKey("SosEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WhaleWatching.Api.Domain.ApplicationUser", "TakenByUser")
                        .WithMany()
